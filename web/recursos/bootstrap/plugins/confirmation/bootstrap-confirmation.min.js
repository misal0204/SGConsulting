...
+function ($) { "use strict";
  ...
  var Confirmation = function (element, options) {
    ...
    $(element).unbind('show.bs.confirmation').on('show.bs.confirmation', function(e) {
    ...
    $(element).unbind('shown.bs.confirmation').on('shown.bs.confirmation', function(e) {
      var options = that.options;
      var all = options.all_selector;
      $(this).next('.popover').one('click.dismiss.confirmation', '[data-dismiss="confirmation"]', $.proxy(that.hide, that))
      if(that.isPopout()) {
    if(!event_body) {
      event_body = $('html').unbind('click').on('click', function (e) {
  ...
  Confirmation.DEFAULTS = $.extend({} , $.fn.popover.Constructor.DEFAULTS, {
    ...
    , template: '<div class="popover">' +
            ...
            '</div>' +
            '</div>'
    , btnOkClass:  'btn-bricky'
    , btnCancelClass:  'btn-default'
    , btnOkLabel: '<i class="clip-checkmark-2"></i> Sí'
    , btnCancelLabel: '<i class="clip-close"></i> No'
    , singleton: false
    , popout: false
    , onConfirm: function(){}
    , onCancel: function(){}
  ...
  Confirmation.prototype.setContent = function () {
    ...
    btnOk.addClass(btnOkClass).html(btnOkLabel).attr('href', href).attr('target', target).unbind('click').on('click', o.onConfirm);
    btnCancel.addClass(btnCancelClass).html(btnCancelLabel).unbind('click').on('click', o.onCancel);
