 ...
 */
@Embeddable
public class SgseguimientoDetallePK implements Serializable {
    ...
    public SgseguimientoDetallePK() {
    }

    public SgseguimientoDetallePK(String idsociedad, String nonc, Date fecha) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgseguimientoDetallePK)) {
            return false;
        }
        SgseguimientoDetallePK other = (SgseguimientoDetallePK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgseguimientoDetallePK[ idsociedad=" + idsociedad + ", nonc=" + nonc + ", fecha=" + fecha + " ]";
    }
