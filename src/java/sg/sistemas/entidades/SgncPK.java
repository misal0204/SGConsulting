 ...
 */
@Embeddable
public class SgncPK implements Serializable {
    ...
    public SgncPK(String idsociedad, String nonc) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgncPK)) {
            return false;
        }
        SgncPK other = (SgncPK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgncPK[ idsociedad=" + idsociedad + ", nonc=" + nonc + " ]";
    }
