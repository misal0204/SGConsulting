 ...
 */
@Embeddable
public class SgeficaciaEmpleadoPK implements Serializable {
    ...
    public SgeficaciaEmpleadoPK() {
    }

    public SgeficaciaEmpleadoPK(String idsociedad, String idplanProg, Date fecha, String codUsuario) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgeficaciaEmpleadoPK)) {
            return false;
        }
        SgeficaciaEmpleadoPK other = (SgeficaciaEmpleadoPK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgeficaciaEmpleadoPK[ idsociedad=" + idsociedad + ", idplanProg=" + idplanProg + ", fecha=" + fecha + ", codUsuario=" + codUsuario + " ]";
    }
