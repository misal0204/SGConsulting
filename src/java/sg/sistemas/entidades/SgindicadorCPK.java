 ...
 */
@Embeddable
public class SgindicadorCPK implements Serializable {
    ...
    public SgindicadorCPK() {
    }

    public SgindicadorCPK(String idsociedad, String idobjIndicador, String iddetalleIo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgindicadorCPK)) {
            return false;
        }
        SgindicadorCPK other = (SgindicadorCPK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgindicadorCPK[ idsociedad=" + idsociedad + ", idobjIndicador=" + idobjIndicador + ", iddetalleIo=" + iddetalleIo + " ]";
    }
