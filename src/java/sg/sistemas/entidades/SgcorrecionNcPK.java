 ...
 */
@Embeddable
public class SgcorrecionNcPK implements Serializable {
    ...
    public SgcorrecionNcPK() {
    }

    public SgcorrecionNcPK(String idsociedad, String nonc) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgcorrecionNcPK)) {
            return false;
        }
        SgcorrecionNcPK other = (SgcorrecionNcPK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgcorrecionNcPK[ idsociedad=" + idsociedad + ", nonc=" + nonc + " ]";
    }
