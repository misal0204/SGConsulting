 ...
 */
@Embeddable
public class SgprocesoDetallePK implements Serializable {
    ...
    public SgprocesoDetallePK() {
    }

    public SgprocesoDetallePK(String idprocesos, String subproceso) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgprocesoDetallePK)) {
            return false;
        }
        SgprocesoDetallePK other = (SgprocesoDetallePK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgprocesoDetallePK[ idprocesos=" + idprocesos + ", subproceso=" + subproceso + " ]";
    }
