 ...
 */
@Embeddable
public class SgindicadorProcesoPK implements Serializable {
    ...
    public SgindicadorProcesoPK() {
    }

    public SgindicadorProcesoPK(String idsociedad, String idobjIndicador) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgindicadorProcesoPK)) {
            return false;
        }
        SgindicadorProcesoPK other = (SgindicadorProcesoPK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgindicadorProcesoPK[ idsociedad=" + idsociedad + ", idobjIndicador=" + idobjIndicador + " ]";
    }
