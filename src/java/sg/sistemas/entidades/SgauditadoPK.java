 ...
 */
@Embeddable
public class SgauditadoPK implements Serializable {
    ...
    public SgauditadoPK(String idsociedad, String idprogAud, String idprocesos, String subproceso) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgauditadoPK)) {
            return false;
        }
        SgauditadoPK other = (SgauditadoPK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgauditadoPK[ idsociedad=" + idsociedad + ", idprogAud=" + idprogAud + ", idprocesos=" + idprocesos + ", subproceso=" + subproceso + " ]";
    }
