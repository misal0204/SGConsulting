 ...
 */
@Embeddable
public class SgprogramaEmpleadoPK implements Serializable {
    ...
    public SgprogramaEmpleadoPK() {
    }

    public SgprogramaEmpleadoPK(String idsociedad, String idplanProg, Date fecha, String codUsuario) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgprogramaEmpleadoPK)) {
            return false;
        }
        SgprogramaEmpleadoPK other = (SgprogramaEmpleadoPK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgprogramaEmpleadoPK[ idsociedad=" + idsociedad + ", idplanProg=" + idplanProg + ", fecha=" + fecha + ", codUsuario=" + codUsuario + " ]";
    }
