 ...
 */
@Embeddable
public class SgeficaciaJefePK implements Serializable {
    ...
    public SgeficaciaJefePK() {
    }

    public SgeficaciaJefePK(String idsociedad, String idplanProg, Date fecha, String codUsuario) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgeficaciaJefePK)) {
            return false;
        }
        SgeficaciaJefePK other = (SgeficaciaJefePK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgeficaciaJefePK[ idsociedad=" + idsociedad + ", idplanProg=" + idplanProg + ", fecha=" + fecha + ", codUsuario=" + codUsuario + " ]";
    }
