 ...
 */
@Embeddable
public class SgdetalleRdireccionPK implements Serializable {
    ...
    public SgdetalleRdireccionPK() {
    }

    public SgdetalleRdireccionPK(String idsociedad, String idtipoPdireccion, String iddetalleDireccion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgdetalleRdireccionPK)) {
            return false;
        }
        SgdetalleRdireccionPK other = (SgdetalleRdireccionPK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgdetalleRdireccionPK[ idsociedad=" + idsociedad + ", idtipoPdireccion=" + idtipoPdireccion + ", iddetalleDireccion=" + iddetalleDireccion + " ]";
    }
