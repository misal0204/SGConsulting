 ...
 */
@Embeddable
public class SgencuestaDetallePK implements Serializable {
    ...
    public SgencuestaDetallePK() {
    }

    public SgencuestaDetallePK(String idsociedad, String noenc) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgencuestaDetallePK)) {
            return false;
        }
        SgencuestaDetallePK other = (SgencuestaDetallePK) object;
    ...
    public String toString() {
        return "sg.sistemas.entidades.SgencuestaDetallePK[ idsociedad=" + idsociedad + ", noenc=" + noenc + " ]";
    }
